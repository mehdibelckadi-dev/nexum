"""Engine: runs all Nexum rules against a normalised spec and returns sorted Findings."""
...
def run(spec: dict[str, Any]) -> list[Finding]:
    """Run every Nexum rule and return all findings sorted by severity (CRITICAL first)."""
